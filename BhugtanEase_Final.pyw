...
if getattr(sys, "frozen", False):
    # PyInstaller EXE — exe file jahan hai wahan data.db banega
...
class InventoryPage(tk.Frame):
    ...
    def _add(self):
        ...
        if data:
            ...
            try:
                ...
                c.execute("INSERT INTO inventory_log (material_id,type,qty,note) VALUES (?,?,?,?)",
    ...
    def _restock(self):
        ...
        def do_add():
            ...
            c.execute("INSERT INTO inventory_log (material_id,type,qty,unit_price,total_cost,note) VALUES (?,?,?,?,?,?)",
            ...
            try:
                if purchase_id:
                    ...
                    cur2 = c.execute("""INSERT INTO purchases
                                        (supplier_name,invoice_no,payment_method,payment_status,total_amount,note)
                                        VALUES (?,?,?,?,?,?)""",
                                     (sv.get() if sv.get()!="— Koi Nahi —" else None,
                                      iv.get().strip() or None, pmv.get(), stv.get(),
                ...
                for x in valid_items:
                    ...
                    if mid:
                        ...
                        c.execute("""INSERT INTO inventory_log
                                     (material_id,type,qty,unit_price,total_cost,note)
                                     VALUES (?,?,?,?,?,?)""",
